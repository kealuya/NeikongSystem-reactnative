...
export default class VersionControl extends Component {
    componentWillMount(){
        //应用注册
        WeChat.registerApp('wxa700a9294d168ca9');
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={this.weixinShare}>
                    <Text style={styles.instructions}>
                        微信分享测试
                    </Text>
                </TouchableOpacity>
            ...
            .then((isInstalled) => {
                if (isInstalled) {
                    WeChat.shareToTimeline({
                            title:'微信朋友圈测试链接',
                            description: '中成智控微信你分享测试',
                            thumbImage: 'https://raw.githubusercontent.com/weflex/react-native-wechat/HEAD/weixin.png',
                            type: 'news',
